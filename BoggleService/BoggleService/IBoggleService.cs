...
namespace Boggle
{
    ...
    public interface IBoggleService
    {
        ...
        /// </summary>
        [WebInvoke(Method = "POST", UriTemplate = "/games",BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ...
        /// </summary>
        [WebInvoke(Method = "PUT", UriTemplate = "/games/{GameID}", BodyStyle = WebMessageBodyStyle.WrappedRequest)]
